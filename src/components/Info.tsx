  ...
  return (
    <div className='bg-white text-gray-900 w-full'>
      <div className='flex justify-center'>
        <div className=' w-[60%] text-center py-16'>
          <h1 className='text-[2.8rem] font-bold'>Last Call to Action</h1>
          <p className='text-[1.3rem]'>Another section content goes here</p>
        </div>
      </div>

      <div className='bg-white text-white min-h-[70vh] flex flex-col justify-center items-center'>
        <div className='w-[90%] xl:w-[1200px] grid grid-cols-1 xl:grid-cols-2 grid-rows-1 gap-x-10 gap-y-12 justify-items-center py-10'>
          <div className='bg-yellow-primary w-[90%] md:w-[550px] min-h-[300px] flex p-[1rem] gap-x-4 rounded-xl shadow-lg'>
            ...
            <div className='w-[60%] flex flex-col gap-y-4 py-4'>
              <div>
                ...
                <h1 className='font-bold text-[1.6rem] leading-8'>Automatic <br /> Prototyping</h1>
              </div>
              <div>
                <p className='text-md'>
          ...
          <div className='bg-green-primary w-[90%] md:w-[550px] min-h-[300px] flex p-[1rem] gap-x-4 rounded-xl shadow-lg'>
            ...
            <div className='w-[60%] flex flex-col gap-y-4 py-4'>
              <div>
                <p className='uppercase text-xs leading-8'>roll out</p>
                <h1 className='font-bold text-[1.6rem] leading-8'>Complexity <br /> Simplified</h1>
              </div>
              <div>
                <p className='text-md'>
